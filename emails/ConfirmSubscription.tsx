...
const ConfirmSubscriptionEmail = ({ link = 'link.com/confirm?fake-token' }) => {
  const previewText = `Confirm subscription to Abel's updates?`
  ...
  return (
    <Layout previewText={previewText}>
      ...
      <Heading className="mx-0 my-[30px] p-0 text-center text-[24px] font-bold text-black">
        Subscribe to Abel&apos;s Updates
      </Heading>
      <Text className="text-[14px] leading-[24px] text-black">Hello!</Text>
      <Text className="text-[14px] leading-[24px] text-black">
        To verify this action, please click the button below to confirm your subscription. Thank you! 🙏
      </Text>
      ...
      <Text className="text-[12px] leading-[24px] text-[#666666]">
        If you didn&apos;t request this, you can ignore this email. If you have any questions, feel free to contact me.
      </Text>
    </Layout>
  )
}
